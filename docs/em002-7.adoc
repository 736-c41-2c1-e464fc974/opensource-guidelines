...
|0
|Externally determined / non-sovereign
...
_Degree of digital sovereignty._
...
_Grad der digitalen Souveränität._

Diese beiden Dimensionen ergeben die folgende Matrix:

[cols="2,1,1,1,1,1",options="header"]
|===
|Perspektive |0 |1 |2 |3 |4
...
In den einzelnen Schnittfeldern (den leeren Zellen) können konkrete Kriterien beschrieben werden, um die Einstufung möglichst objektiv zu gestalten.
...
[cols="1,3,6",options="header"]
|===
|Degré |Désignation abrégée |Description

|0
|Hétéronome / non souverain
...
_Degré de souveraineté numérique._
...
Des critères concrets peuvent être décrits dans les différentes intersections (les cellules vides) afin de rendre le classement aussi objectif que possible.
...
[cols="1,3,6",options="header"]
|===
|Grado |Denominazione breve |Descrizione

|0
|Eterodiretto / non sovrano
...
_Grado di sovranità digitale._

Queste due dimensioni producono la matrice seguente:

[cols="2,1,1,1,1,1",options="header"]
|===
|Prospettiva |0 |1 |2 |3 |4
...
Nelle singole intersezioni (le celle vuote) possono essere descritti criteri concreti per rendere la classificazione il più oggettiva possibile.
...
[cols="1,3,6",options="header"]
|===
|Grad |Denominaziun curta |Descripziun

|0
|Determinà da terzs / betg suveran
...
_Grad da suveranitad digitala._

Questas duas dimensiuns dattan la suandanta matrix:

[cols="2,1,1,1,1,1",options="header"]
|===
|Perspectiva |0 |1 |2 |3 |4
...
En ils singuls champs da cruschada (las cellas vidas) pon vegnir descrits criteris concrets per render la classificaziun uschè objectiva sco pussaivel.
