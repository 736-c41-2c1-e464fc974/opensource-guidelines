...
With the publication obligation according to Art. 9 EMOTA, the procedure described in -2 link:em002-2.pdf[Em002-2 Instructions for Publishing OSS] should be followed here.
